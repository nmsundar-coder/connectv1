            ...
            return (
                <KeyboardAwareScrollView>
                    <View style={{height: Dimensions.get('window').height, backgroundColor: 'white'}}>
                        ...
                        <Text style={{fontSize:30, color: '4bccb9', marginLeft: 'auto', marginRight: 'auto'}}>Thanks for registering!</Text>
                        <Text style={{fontSize:18, color: 'black', marginLeft: 20, marginBottom: 30, marginTop: 15}}>A verification email has been sent to your email</Text>
                       
                        <Animated.View style={[commonStyles.button1]}>
                            <TouchableOpacity style={{borderRadius: 5, backgroundColor: '#6846C6'}} onPress={() => {
                                this.navigation.navigate('Login', { name: 'Jane' });
                            }}>
                                <Text style={{fontSize: 16, fontWeight: 'bold', marginTop: 15, marginBottom: 15, marginLeft: 20, marginRight: 20, color: 'white'}}>Login</Text>
                            </TouchableOpacity>
                        </Animated.View>
