...
import { Text, View, Dimensions, Image, Linking, BackHandler} from 'react-native'
                ...
                <View style={{height: Dimensions.get('window').height}}>
                    ...
                    <View style={{height: '25%', marginHorizontal: 30, marginVertical: 20, backgroundColor: '#fff', flex: 1, justifyContent: 'flex-end', borderColor: '#d4d4d4', borderWidth: 1}}>
                        <TouchableOpacity style={{justifyContent: 'flex-end', height: '100%'}} onPress={() => {
                            ...
                            <View style={{height: '30%', backgroundColor: '#fff', opacity: 0.7, justifyContent: 'center'}}>
                                <Text style={{color: '#000', fontSize: 18, fontWeight: 'bold', marginLeft: 5}}> Request a Callback</Text>
                            </View>
                        </TouchableOpacity>
                    </View>
                    {this.props.authData.isApproved==='Y'?(
                    <View style={{flexDirection: 'row', height: '25%'}}>
                        <View style={{width: '45%', marginLeft: 30, marginRight: 15, marginVertical: 20, backgroundColor: '#fff', flex: 1, justifyContent: 'flex-end', borderColor: '#d4d4d4', borderWidth: 1}}>
                            <TouchableOpacity style={{justifyContent: 'flex-end', height: '100%'}} onPress={() => {
                                ...
                                <View style={{height: '30%', backgroundColor: '#fff', opacity: 0.7, justifyContent: 'center'}}>
                                    <Text style={{color: '#000', fontSize: 18, fontWeight: 'bold', marginLeft: 5}}> My Interests</Text>
                                </View>
                            </TouchableOpacity>
                        </View>
                        <View style={{width: '45%', marginLeft: 15, marginRight: 30, marginVertical: 20, backgroundColor: '#fff', flex: 1, justifyContent: 'flex-end', borderColor: '#d4d4d4', borderWidth: 1}}>
                        <TouchableOpacity style={{justifyContent: 'flex-end', height: '100%'}} onPress={() => {
                            ...
                            <View style={{height: '30%', backgroundColor: '#fff', opacity: 0.7, justifyContent: 'center'}}>
                                <Text style={{color: '#000', fontSize: 18, fontWeight: 'bold', marginLeft: 5}}> My Accounts</Text>
                            </View>
                        </TouchableOpacity>
                    </View>
                    </View>
                    ...
                    <View style={{height: '25%', marginHorizontal: 30, marginVertical: 20, backgroundColor: '#fff',flex: 1, justifyContent: 'flex-end', borderColor: '#d4d4d4', borderWidth: 1}}>
                        <TouchableOpacity style={{justifyContent: 'flex-end', height: '100%'}} onPress={() => Linking.openURL('https://expleogroup.com/about-us/')}>
                            ...
                            <View style={{height: '30%', backgroundColor: '#fff', opacity: 0.7, justifyContent: 'center'}}>
                                <Text style={{color: '#000', fontSize: 18, fontWeight: 'bold', marginLeft: 5}}> Discover Expleo</Text>
                            </View>
                        </TouchableOpacity>
                    </View>
